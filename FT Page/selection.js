...
window.data = {
    HeroWithCTA: {
        Eyebrow: "Blazor Data Grid Selection",
        MainTitle: "Build Flexible Row, Cell & Column Selection for Real Workflows",
        Subtitle: "Create, customize, and control multiple selection modes in the Syncfusion Blazor Data Grid with fine-grained control.",
        ViewDemo: "View Demo",
    ...
    ChooseRightApproach: {
        ...
        Options: [
            ...
            },
            {
                ...
                Content: "Allowing to select a range of cells or rows by dragging with a mouse or touch input. ",
                BestFor: "Quick range selection, continuous data selection, and touch-friendly interfaces.",
                UseWhen: "Users prefer drag interactions for selecting multiple adjacent rows or cells, or when working on touch devices where multi-select shortcuts may be unavailable.",
            },
            {
            ...
            },
            {
                ...
                Content: "Allowing selected rows to remain selected even after data operations or Grid refreshes. This feature is useful for maintaining selection state across various interactions.",
                BestFor: "Data workflows with multiple operations, pagination, dynamic data updates, and maintaining user focus across interactions.",
                UseWhen: "Users need to keep their selections active while performing other operations, navigating between pages, or when the grid data is refreshed but selections should remain intact.",
            }
        ]
    },
    Resources: {
        ...
        Options: [
            {
                ...
                ReadGuideORViewDemoLink: "https://blazor.syncfusion.com/documentation/datagrid/row-selection",
            },
            {
                ...
                ReadGuideORViewDemoLink: "https://sfblazor.azurewebsites.net/development/net10/demos/datagrid/selection?theme=fluent2",
            },
            {
                Title: "Checkbox Selection Documentation",
                Content: "Implement checkbox-based selection for better UX and accessibility.",
                ReadGuideORViewDemoTitle: "View Documentation",
                ReadGuideORViewDemoLink: "https://blazor.syncfusion.com/documentation/datagrid/checkbox-selection",
            },
            {
                Title: "Checkbox Selection Demo",
                Content: "See checkbox selection in action with interactive examples and code snippets.",
                ReadGuideORViewDemoTitle: "View Demo",
                ReadGuideORViewDemoLink: "https://sfblazor.azurewebsites.net/development/net10/demos/datagrid/checkbox-selection?theme=fluent2",
            },
            {
                Title: "Cell Selection Documentation",
                Content: "Learn how to implement cell selection for granular data interaction.",
                ReadGuideORViewDemoTitle: "View Documentation",
                ReadGuideORViewDemoLink: "https://blazor.syncfusion.com/documentation/datagrid/cell-selection",
            },
            {
                Title: "Drag Selection Documentation",
                Content: "Allowing to select a range of cells or rows by dragging with a mouse or touch input.",
                ReadGuideORViewDemoTitle: "View Documentation",
                ReadGuideORViewDemoLink: "https://blazor.syncfusion.com/documentation/datagrid/selection#drag-selection",
            },
        ]
    },
    FAQ: {
        Eyebrow: "FAQ",
        MainTitle: "Blazor Data Grid Selection Questions",
        Subtitle: "",
        Options: [
            {
                Question: "What selection modes are available?",
                Answer: "The Syncfusion Blazor Data Grid supports Row Selection (normal and checkbox), Cell Selection, and Drag Selection. Each mode can be combined with keyboard shortcuts and conditional logic to match your workflow needs."
            },
            {
    ...
    RelatedArticles: {
        ...
        MainTitle: "Continue Exploring Blazor Data Grid Selection",
        Subtitle: "",
        Options: [
            {
                Title: "Blazor Data Grid Selection Guide",
...
document.getElementsByClassName("hero")[0].innerHTML = `<div class="container">
            ...
            <div class="hero-ctas">
                <a href="#demo-section" class="btn btn-primary">${data.HeroWithCTA.ViewDemo}</a>
                <a href="#resources" class="btn btn-secondary">${data.HeroWithCTA.ExploreDoc}</a>
            </div>
        </div>`
