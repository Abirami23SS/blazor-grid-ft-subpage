window.data = {
  "HeroWithCTA": {
    "Eyebrow": "BLAZOR DATA GRID LARGE DATASETS",
  ...
  "Resources": {
    ...
    "Subtitle": "Find everything you need to implement performance optimization in your Blazor grid applications.",
    "Options": [
      {
      ...
      },
      {
        ...
        "Content": "Step-by-step guide to set up Blazor Grid with performance features in your application.",
  ...
  "FAQ": {
    "Eyebrow": "FAQ",
    "MainTitle": "Blazor Data Grid Large Dataset Questions",
    "Subtitle": "",
    "Options": [
      {
        "Question": "Can the Syncfusion Blazor Grid handle large datasets efficiently?",
  ...
  "RelatedArticles": {
    ...
    "Subtitle": "Continue Exploring Blazor Data Grid Performance Optimization",
    "Options": [
      {
      ...
      {
        "Title": "Blazor Grid Performance Optimization Tips",
