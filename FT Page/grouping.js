...
window.data = {
  "HeroWithCTA": {
    "Eyebrow": "Blazor Data Grid · Grouping & Aggregates",
  ...
  "RelatedArticles": {
    ...
    "Options": [
      ...
      {
        "Title": "Using Group Caption Aggregates in Blazor Data Grid",
